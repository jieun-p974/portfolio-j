package com.lecture.portfolio.admin.context.experience.controller

import com.lecture.portfolio.admin.context.experience.service.AdminExperienceService
...
class AdminExperienceViewController(
    ...
    fun experience(model: Model): String {
        ...
        val formElements = listOf<FormElementDTO>(
            ...
            SelectFormElementDTO("endYear", 3, (2010..2030).toList()), // 연도 제한
